    ...
    *,
    ...
    if profile == "gateway":
        ...
        generate_edge_config(
            ...
            hx711_dout_pin=int(edge_config.get("hx711_dout_pin", 1)),
            hx711_sck_pin=int(edge_config.get("hx711_sck_pin", 3)),
            ds18b20_pin=int(edge_config.get("ds18b20_pin", 4)),
            weight_mode=edge_config.get("weight_mode", "full"),
